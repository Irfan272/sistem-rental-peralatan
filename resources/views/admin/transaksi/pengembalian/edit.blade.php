                            ...
                            <form class="" action="/admin/kelas/update/{{ $k->id }}" method="post" novalidate>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ $k->nama_kelas }}" class="@error('nama_kelas') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="nama_kelas" required="required" />
                                        @error('nama_kelas')
