        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form enctype="multipart/form-data" action="/alat/store" method="post" novalidate>
                            @csrf
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="Merk">Merk <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input value="{{ old('merk') }}" id="merk" name="merk" class="form-control @error('merk') parsley-error @enderror" type="text" />
                                    @error('merk')
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required">{{ $message }}</li>
                                    </ul>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input value="{{ old('type') }}" id="type" name="type" class="form-control @error('type') parsley-error @enderror" type="text" />
                                    @error('type')
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required">{{ $message }}</li>
                                    </ul>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="input-group">
                                        <input value="{{ old('harga_perhari') }}" id="harga_perhari" name="harga_perhari" class="form-control @error('harga_perhari') parsley-error @enderror" type="text" />
                                    </div>
                                    @error('harga_perhari')
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required">{{ $message }}</li>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="input-group">
                                        <input value="{{ old('denda_perhari') }}" id="denda_perhari" name="denda_perhari" class="form-control @error('denda_perhari') parsley-error @enderror" type="text" />
                                    </div>
                                    @error('denda_perhari')
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required">{{ $message }}</li>
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="type">Gambar Alat <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input value="{{ old('gambar_alat') }}" id="type" name="gambar_alat" class="form-control @error('gambar_alat') parsley-error @enderror" type="text" />
                                    @error('gambar_alat')
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required">{{ $message }}</li>
                                    </ul>
