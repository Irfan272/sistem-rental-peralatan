                            ...
                            <form class=""  enctype="multipart/form-data" action="/admin/barang/store" method="post" novalidate>
                               @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="Dus" name="satuan" readonly class="@error('satuan') parsley-error @enderror form-control" class='optional' data-validate-length-range="5,15" type="text" />
                                        @error('satuan')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="input-group">
                                            <input value="{{ old('harga') }}" name="harga" class="@error('harga') parsley-error @enderror form-control" class="optional" data-validate-length-range="5,15" type="text" />
                                            @error('harga')
                                            <ul class="parsley-errors-list filled">
                                                <li class="parsley-required">{{ $message }}</li>
                                            </ul>   
